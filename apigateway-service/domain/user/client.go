...
type Client interface {
	Register(user User) (name string, tokens auth.Tokens, message string, err error)
	Delete(id uuid.UUID) (message string, err error)
	...
	UpdateProfile(id uuid.UUID, name *string, address *string) (message string, newName string, err error)
}
