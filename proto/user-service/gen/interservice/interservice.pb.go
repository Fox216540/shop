...
const file_user_service_interservice_proto_rawDesc = "" +
	"\n" +
	"\x1fuser-service/interservice.proto\x12\x11user.interservice\x1a\x12common/types.proto\"?\n" +
	"\x19VerifyCredentialsResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name2t\n" +
	"\x13InterserviceService\x12]\n" +
	"\x11VerifyCredentials\x12\x1a.common.CredentialsRequest\x1a,.user.interservice.VerifyCredentialsResponseBEZCgithub.com/Fox216540/shop/proto/user-service/gen/interservice;protob\x06proto3"
...
var file_user_service_interservice_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_user_service_interservice_proto_goTypes = []any{
	(*VerifyCredentialsResponse)(nil), // 0: user.interservice.VerifyCredentialsResponse
	(*gen.CredentialsRequest)(nil),    // 1: common.CredentialsRequest
}
var file_user_service_interservice_proto_depIdxs = []int32{
	1, // 0: user.interservice.InterserviceService.VerifyCredentials:input_type -> common.CredentialsRequest
	0, // 1: user.interservice.InterserviceService.VerifyCredentials:output_type -> user.interservice.VerifyCredentialsResponse
